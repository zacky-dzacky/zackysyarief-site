...
> **Update:** this is the first iteration of the project. It has since grown into **Caridata** — hybrid dense + SPLADE retrieval over Qdrant, a web app, and Google sign-in with per-user documents — which is live at [caridata.zackysyarief.com](https://caridata.zackysyarief.com) and written up in [Caridata: hybrid search RAG you can actually log into](/blog/caridata-hybrid-rag). Start here for the fundamentals, then read that one.
